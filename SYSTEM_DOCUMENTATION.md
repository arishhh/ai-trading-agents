...
- **Manual Override**: A global Pause/Resume toggle to instantly halt automated trading.
...
- `PAPER_MODE`: Set to `true` for simulated trading without real capital risk.
