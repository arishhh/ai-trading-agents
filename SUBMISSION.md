...
**Long Description**:
KrakenAI Trader is an end-to-end autonomous agent that manages a crypto portfolio with institutional-grade logic. Every 10 minutes, the agent fetches live BTC/USD ticker and OHLC data from Kraken, along with RSI and volatility signals from the PRISM API. This high-density market context is processed by a Groq-powered 70B LLM brain, which generates a trade decision paired with a detailed "Internal Monologue" reasoning log.
