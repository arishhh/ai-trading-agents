      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-black/50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex gap-8">
            <Link href="/" className="text-sm hover:text-[#00FF88] transition-colors">DASHBOARD</Link>
      ...
      <section className="relative min-h-screen pt-32 pb-20 px-6 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link href="/" className="px-10 py-4 bg-[#00FF88] text-black font-bold rounded-sm hover:bg-[#00DD77] transition-all hover:scale-[1.02] active:scale-[0.98]">
              VIEW LIVE DASHBOARD
            </Link>
