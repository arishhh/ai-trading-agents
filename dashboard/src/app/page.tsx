        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <Link href="/" className="hover:opacity-80 transition-opacity">
              <h1 className="text-3xl md:text-5xl font-black font-[family-name:var(--font-space-grotesk)] tracking-tighter text-white mb-1 uppercase text-left">
            ...
            <div className="flex flex-col md:flex-row gap-2 md:gap-6 mt-1">
              ...
              <Link href="/about" className="text-white/40 hover:text-[#00FF41] font-bold flex items-center gap-2 text-[10px] tracking-[0.2em] uppercase transition-colors border-l border-white/10 pl-6 ml-2">
                About Agent →
              </Link>
            </div>
          </div>
